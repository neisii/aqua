...
--
-- Table structure for table `ki0000_c`
--

DROP TABLE IF EXISTS `ki0000_c`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ki0000_c` (
  `chlight` varchar(10) NOT NULL,
  `chheat` varchar(10) DEFAULT NULL,
  `chcool` varchar(10) DEFAULT NULL,
  `cltimes` varchar(20) DEFAULT NULL,
  `cltimee` varchar(20) DEFAULT NULL,
...
--
-- Dumping data for table `ki0000_c`
--

LOCK TABLES `ki0000_c` WRITE;
/*!40000 ALTER TABLE `ki0000_c` DISABLE KEYS */;
INSERT INTO `ki0000_c` VALUES ('off','off','off','00:00:00','00:00:00',22,27,'no','no');
/*!40000 ALTER TABLE `ki0000_c` ENABLE KEYS */;
UNLOCK TABLES;
