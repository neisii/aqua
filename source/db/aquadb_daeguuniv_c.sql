...
--
-- Table structure for table `daeguuniv_c`
--

DROP TABLE IF EXISTS `daeguuniv_c`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `daeguuniv_c` (
...
--
-- Dumping data for table `daeguuniv_c`
--

LOCK TABLES `daeguuniv_c` WRITE;
/*!40000 ALTER TABLE `daeguuniv_c` DISABLE KEYS */;
INSERT INTO `daeguuniv_c` VALUES ('on','on','off','10:15:00','16:22:00',0,0,'no','no');
/*!40000 ALTER TABLE `daeguuniv_c` ENABLE KEYS */;
UNLOCK TABLES;
