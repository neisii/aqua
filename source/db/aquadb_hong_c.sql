...
--
-- Table structure for table `hong_c`
--

DROP TABLE IF EXISTS `hong_c`;
...
--
-- Dumping data for table `hong_c`
--

LOCK TABLES `hong_c` WRITE;
/*!40000 ALTER TABLE `hong_c` DISABLE KEYS */;
INSERT INTO `hong_c` VALUES ('off','off','off','00:00:00','00:00:00',22,27,'no','no');
/*!40000 ALTER TABLE `hong_c` ENABLE KEYS */;
UNLOCK TABLES;
